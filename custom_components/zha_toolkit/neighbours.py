...
async def routes_and_neighbours(app, listener, ieee, cmd, data, service, params={}, event_data={}):
    if ieee is None:
...
async def all_routes_and_neighbours(app, listener, ieee, cmd, data, service, params={}, event_data={}):
